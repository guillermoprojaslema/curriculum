...
\cventry{Actualidad}{Programador}{Freelance}{Santiago}{Puente Alto}{Desarrollando un sistema de información, enfocado la vitrina de prouctos del rubro de la gestión inmobiliaria, dentro de una PYME, en PHP bajo el framework de Laravel 5.4. Puedes revisarlo \href{http://makpropiedades.herokuapp.com}{\textcolor{blue}{aquí}}} 

\cventry{Agosto 2017--Septiembre 2017}{Programador}{Freelance}{Santiago}{Puente Alto}{Desarrollando un sistema de información, enfocado la vitrina de prouctos del rubro de la gestión inmobiliaria, dentro de una PYME, en PHP bajo el framework de Laravel 5.5. Puedes revisarlo \href{http://makpropiedades.herokuapp.com}{\textcolor{blue}{aquí}}} 
