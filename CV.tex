...
\cventry{Noviembre 2017--Enero 2018}{Programador}{Inmotion}{Santiago}{Las Condes}{Desarrollo de funcionalidad de sistema de información, enfocado al agendamiento y gestión de horas médicas, enfocado a pacientes, administradores, médicos, de varios centros de salud pública y privada, donde la información es consumida a través de una API, para su posterior uso en una aplicación de Andriod y iOS, en PHP 7.1 bajo el framework de Laravel 5.4.
Programador para Inmotion}

\cventry{Agosto 2017--Octubre 2017}{Programador}{Innovit}{Santiago}{Providencia}{Desarrollo de funcionalidad de sistema de información, enfocado al agendamiento y gestión de horas médicas, de varios centro de salud pública de la comuna de Cabrero, en PHP 7.1 bajo el framework de Laravel 5.2.
